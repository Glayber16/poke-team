...
export class TeamController {
  static getAllTeams(req: Request, res: Response) {
    const teams = TeamService.getAllTeams();
    return res.status(200).json(teams); //Retorna o array de times com status 200, caso esteja vazio retorna []
  }
  ...
  static removePokemon(req: Request, res: Response) {
    ...
    try {
      const updatedTeam = TeamService.removePokemon(id, pokemonName); //Tenta remover o pokemon do time utilizando o service
